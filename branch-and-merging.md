1. What does git clean do? fatal:clean.requireForce defaults to true and neither -i, -n, nor -f given; refusing to clean tidak bisa digunakan git clean karena tidak ada -i,-n atau -f
